...
export const KIWIFY_PRODUCTS = {
  starter: {
    ...
    checkoutUrl: process.env.VITE_KIWIFY_STARTER_URL || 'https://checkout.kiwify.com.br/starter-placeholder',
  },
  pro: {
    productId: 'KIWIFY_PRO_ID', // To be replaced with actual product ID  
    checkoutUrl: process.env.VITE_KIWIFY_PRO_URL || 'https://checkout.kiwify.com.br/pro-placeholder',
  },
  black_belt: {
    productId: 'KIWIFY_BLACK_BELT_ID', // To be replaced with actual product ID
    checkoutUrl: process.env.VITE_KIWIFY_BLACK_BELT_URL || 'https://checkout.kiwify.com.br/black-belt-placeholder',
  }
} as const;
